  ...
  return (
    <div className="flex flex-col items-end gap-1.5">
      <div className="flex items-center gap-2">
        <label className="flex cursor-pointer items-center gap-1.5 text-[10px] text-foreground-subtle">
          <input
            type="checkbox"
      ...
      {!autoSyncMissingSquads && !result && (
        <p className="max-w-[18rem] text-right text-[10px] text-foreground-subtle">
