          ...
          {options.map((option, index) => (
            <div key={index} className="flex items-center gap-2">
              <input
                ...
                className="w-full rounded-lg border border-hairline bg-transparent px-3 py-1.5 text-sm text-foreground placeholder:text-foreground-subtle focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/60"
              />
