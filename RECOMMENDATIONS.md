...
29. **Security/Product** — KIVO's moderation queue will spike exactly when live match rooms are most active (controversial goals/VAR calls) — borrowing Zendesk/Intercom/Reddit triage mechanics (SLA-aware sort, visible auto-tag rationale, bulk-action caps, multi-moderator presence) is a P1 requirement, not later hardening. **Status**: Proposed.
